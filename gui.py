...
import cv2
from image import Image             # Imageクラスの読み込み
from data_logger import DataLogger  # DataLoggerクラスの読み込み
...
class MyApp:
    ...
    # 「正解基板確認」を押されたときの処理  正解基板の画像を受け取る
    def check_correct_image(self):
        # 本番では以下の2種類のどちらかを使う

        # 保存されたcorrect_imgを呼ぶパターン
